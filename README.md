...
![各小班成绩构成可能不同，通常包含平时表现、短文、长文和口头汇报。](https://img.shields.io/badge/各小班成绩构成可能不同，通常包含平时表现、短文、长文和口头汇报。--wheat)

学校对这门课的定位是：「课程以具有通识性质的主题为依托，以小班研讨为开展形式，要求学生在特定主题下，结合自我认知、知识储备、文献阅读，撰写说理性文字。经过本课程的学习与实践，可提升学生的文字表达能力、口头沟通能力，提升学生对说理文写作的认知，为后续的毕业论文写作、毕业答辩、其他说理性写作、特定场景的有效沟通奠定坚实基础。」

省流一下就是：教你写论文。

特别注意：
这门课实际上是围绕某个主题来上课的，不同班的主题也不同。在本研平台选课界面的课程名称一栏中，括号内的内容即为主题。
建议选择自己有兴趣的主题，否则硬要水出一篇 5000 字论文还是不好受的。
...
## 主题
<!-- TOML-SECTION: title="主题" -->

<!-- TOML-ITEM: id="item-主题-1" -->
...
「批判性思维」这个主题乍一看很抽象，但老师对写作主题没有严格要求。核心是寻找一个问题（「失稳状态」），并证明这个问题值得研究，然后用批判性思维去分析、解决问题。
...
<!-- TOML-ITEM: id="item-主题-5" -->

授课风格：24-26主题都没变（听说原本是打算换成人工智能主题），老王太夯了，老师完全不会挂人，打分之类的事情会和同学直接说明，想不来直接和老师发邮件请假就行，上课也幽默风趣，有很多干货（就业/保研/升学），而且比较会调动气氛，上课会发免费的小甜水。

> 文 / [离谱](https://github.com/LiPu-jpg)，2026-03

<!-- TOML-ITEM: id="item-主题-6" -->
...
<!-- TOML-ITEM: id="item-主题-7" -->

### 丝绸之路

授课老师：林英

授课风格：老师人很和蔼，上课氛围轻松，一般采用纸质签到。课堂上会随机请部分同学朗读历史文献。平时几乎没有额外作业，考核主要包括一篇1500字的期中短文、一篇5000字左右的期末论文以及期末展示。老师对论文批改非常认真，每位同学的期末论文都会收到较为详细的点评和反馈。课程以丝绸之路为主题，整体难度不高，可选择的论文选题很多。老师会介绍大量与丝绸之路相关的历史文献，并针对同学们的选题提出具体建议。给分相对宽松，只要按时提交了论文和参加汇报，一般都能取得不错的成绩。

教学流程：确定选题 -> 短文写作 -> 小组讨论会 -> 长文写作 -> 期末汇报
